...
function setupImageUpload() {
  const fileInput = document.getElementById("jokeImageFile");
...
async function handleAdd() {
  ...
  try {
    await addJoke(title, content, categoryId, rating, selectedImageFile);

    jokeTitle.value = "";
    jokeContent.value = "";
    if (document.getElementById("jokeImageFile")) {
      document.getElementById("jokeImageFile").value = "";
    }
    selectedImageFile = null;
    const imagePreview = document.getElementById("imagePreview");
    if (imagePreview) {
